...
- [Table of contents](#table-of-contents)
  ...
  - [API Documentation - Version: 1.0](#api-documentation---version-10)
    - [/v1/import-from-file](#v1import-from-file)
    - [/v1/import-from-file/status/{jobId}](#v1import-from-filestatusjobid)
    - [Models](#models)
...
## Technologies
    Java 8
    Spring (Boot, Web, Data JPA, Batch, Cloud Netflix Hystrix, Cloud Netflix Eureka)
...
After start the application, you can access:
	...
	Swagger interface (Gateway) - localhost:5555/log-request-import-service/swagger-ui/index.html
	
	
	Swagger interface (direct access) - localhost:8082/swagger-ui/index.html
