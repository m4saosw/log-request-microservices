...
Log Request Service API DDD

This project is equivalent to the log-request-service v1 project with the difference that it is structured as Domain Driven Design (DDD) and based on Clean Architecture (simplified).
